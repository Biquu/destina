...
export default function Question16() {
  ...
  const handleNext = () => {
    localStorage.setItem('Cooking', answer);
    router.push('/questions/question17');
  };

  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F3FAF7]">
      <div className="bg-white p-8 rounded shadow-lg max-w-lg w-full">
        <h1 className="text-2xl font-bold mb-4 text-darkest-blue">Yemek yapmaya olan ilginiz nedir? (0-10 arası bir değer giriniz)</h1>
        <input
          type="number"
          value={answer}
